package com.example.gutierrez.webservices;
...
public class Insert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        clean();
        if(!mname.equals("") && !maddress.equals(""))save.setText("Modificar");
    ...
    private class Inserting extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            try{
                URL url = new URL("http://192.168.43.93/datos1/insertar_alumno.php");
    ...
    private class Modify extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try{
                URL url = new URL("http://192.168.43.93/datos1/actualizar_alumno.php");
                Log.d("url",url.toString());
                HttpURLConnection httpURLConnection =(HttpURLConnection) url.openConnection();
                httpURLConnection.setRequestMethod("POST");
                httpURLConnection.setRequestProperty("Content-Type","application/json");
